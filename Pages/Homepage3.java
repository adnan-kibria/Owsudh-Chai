...
//1		
		...
		j2 = new JLabel("Medicine Name: Magnesia ");
...
//6		
		...
		j28 = new JLabel("Medicine Name: Zofen ");
...
//7  
		...
		j31 = new JLabel("Medicine Name: Biofol ");
...
//8		
		...
		j34 = new JLabel("Medicine Name: Hitagen ");
...
//9		
		...
		j37 = new JLabel("Medicine Name: Amsiv ");
...
//10    
		...
		j40 = new JLabel("Medicine Name: Bukof ");
...
//11
		...
		//mainPanel2.setBackground(c2);
		 ...
		 img1 = new ImageIcon("Image1/img21.jpeg");
			j5 = new JLabel(img1);
			j5.setBounds(155,100,90,160);
			mainPanel.add(j5);
			
			
			img2 = new ImageIcon("Image1/img22.jpeg");
			j6 = new JLabel(img2);
			j6.setBounds(305,100,90,160);
			mainPanel.add(j6);

		  img3 = new ImageIcon("Image1/img23.jpeg");
			j7 = new JLabel(img3);
			j7.setBounds(445,100,90,160);
			mainPanel.add(j7);

		   img4 = new ImageIcon("Image1/img24.jpeg");
			j8 = new JLabel(img4);
			j8.setBounds(585,100,90,160);
			mainPanel.add(j8);
			
		  img5 = new ImageIcon("Image1/img25.jpeg");
			j9 = new JLabel(img5);
			j9.setBounds(725,100,90,160);
			mainPanel.add(j9);
		
		 img6 = new ImageIcon("Image1/img26.jpeg");
			j10 = new JLabel(img6);
			j10.setBounds(155,310,90,160);
			mainPanel.add(j10);
			
			img7 = new ImageIcon("Image1/img27.jpeg");
			j11 = new JLabel(img7);
			j11.setBounds(305,310,90,160);
			mainPanel.add(j11);
		
		 img8 = new ImageIcon("Image1/img28.jpeg");
			j12 = new JLabel(img8);
			j12.setBounds(445,310,90,160);
			mainPanel.add(j12);
			
			img9 = new ImageIcon("Image1/img29.jpeg");
			j13 = new JLabel(img9);
			j13.setBounds(585,310,90,160);
			mainPanel.add(j9);
			
			img10 = new ImageIcon("Image1/img30.jpeg");
    ...
    public void actionPerformed(ActionEvent e) 
	{
	    ...
	    else if (e.getSource() == b10) 
		{
			...
			JOptionPane.showMessageDialog(null,"Magnesia "+selectedValue1+"PIECES\n"+"PRICE "+(selectedValue*52));
        }
		//add to cart2 
	    else if (e.getSource() == b11) 
		{
			...
			JOptionPane.showMessageDialog(null,"Losardil"+selectedValue2+"PIECES\n"+"PRICE "+(selectedValue*60));
        }
		//add to cart 3 
		else if (e.getSource() == b12) 
		{
			...
			JOptionPane.showMessageDialog(null,"PASE"+selectedValue3+"PIECES\n"+"PRICE "+(selectedValue*90));
        }
		...
		else if (e.getSource() == b13) 
		{
			...
			JOptionPane.showMessageDialog(null,"Leptic"+selectedValue4+"PIECES\n"+"PRICE "+(selectedValue*60));
        }
		...
		else if (e.getSource() == b14) 
		{
			...
			JOptionPane.showMessageDialog(null,"Arotril"+selectedValue5+"PIECES\n"+"PRICE "+(selectedValue*70));
        }
		...
		else if (e.getSource() == b15) 
		{
			...
			JOptionPane.showMessageDialog(null,"Zofen"+selectedValue6+"PIECES\n"+"PRICE "+(selectedValue*30));
        }
		...
		else if (e.getSource() == b16) 
		{
			...
			JOptionPane.showMessageDialog(null,"Biofol"+selectedValue7+"PIECES\n"+"PRICE "+(selectedValue*81));
        }
		...
		else if (e.getSource() == b17) 
		{
			...
			JOptionPane.showMessageDialog(null,"Hitagen"+selectedValue8+"PIECES\n"+"PRICE "+(selectedValue*100));
        }
		...
		else if (e.getSource() == b18) 
		{
			...
			JOptionPane.showMessageDialog(null,"Amsiv"+selectedValue9+"PIECES\n"+"PRICE "+(selectedValue*40));
        }
		...
		else if (e.getSource() == b19) 
		{
			...
			JOptionPane.showMessageDialog(null,"Bukof"+selectedValue10+"PIECES\n"+"PRICE "+(selectedValue*74));
        }
