...
public class Homepage7 extends JFrame implements ActionListener {
    ...
    public Homepage7() {
        ...
        ImageIcon ImageIcon = new ImageIcon("homepage2/L1.png");
        Image Image = ImageIcon.getImage();
        f.setIconImage(Image);

        JLabel Background;
        ImageIcon img = new ImageIcon("homepage2/P1.png");
        Background = new JLabel("", img, JLabel.CENTER);
        Background.setBounds(0, 0, 1000, 620);
        
        JLabel imageLabel1 = createImageLabel("homepage2/image.jpg", 150, 80, 100, 100, "Fexo", "10", "10");
        JLabel imageLabel2 = createImageLabel("homepage2/image1.jpg", 350, 80, 100, 100, "Fexo Tab 120", "18", "15");
        JLabel imageLabel3 = createImageLabel("homepage2/image2.jpg", 550, 80, 100, 100, "Napa", "20", "20");
        JLabel imageLabel7 = createImageLabel("homepage2/image3.jpg", 750, 80, 100, 100, "Napa Extend", "25", "25");
        JLabel imageLabel4 = createImageLabel("homepage2/image4.jpg", 150, 300, 100, 100, "Fenadin", "30", "30");
        JLabel imageLabel5 = createImageLabel("homepage2/image5.jpg", 350, 300, 100, 100, "Fenadin Tab", "35", "35");
        JLabel imageLabel6 = createImageLabel("homepage2/image6.jpg", 550, 300, 100, 100, "Iwilfin", "70", "40");
        JLabel imageLabel8 = createImageLabel("homepage2/image7.jpg", 750, 300, 100, 100, "Abilify", "85", "45");
    ...
    public void actionPerformed(ActionEvent e) 
	{
        if (e.getSource() == b1) 
		{
            int choice = JOptionPane.showConfirmDialog(null, " DO YOU WANT TO GO HOME PAGE ? ", "BACK HOME PAGE",
