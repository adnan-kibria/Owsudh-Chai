...
package Openning.Entry.Login;

import javax.swing.*;


import Openning.Entry.*;
import Openning.Entry.Admin.AdminPortal.AdminPortal;
        ...
        if (ae.getSource() == jB1)
        {
            String tField = jTF1.getText(); 
                ...
                if (tField.isEmpty() || pField.isEmpty()) {
                    ...
                    try {
                        String userNameS = "User Name: " + tField;
                        String passwordS = "Password: " + pField;
                        BufferedReader reader = new BufferedReader(new FileReader("./Openning/Entry/Login/Privatedata.txt"));
                        ...
                        for (int i = 0; i <= totalLines; i++) {
                            String line = Files.readAllLines(Paths.get("./Openning/Entry/Login/Privatedata.txt")).get(i);
                            if (line.equals(userNameS)) {
                                String line2 = Files.readAllLines(Paths.get("./Openning/Entry/Login/Privatedata.txt")).get((i + 1));
                                if (line2.equals(passwordS)) {
                                    JOptionPane.showMessageDialog(null, "Login Successful.", "Owsudh Chai",
                                            JOptionPane.WARNING_MESSAGE);
                        ...
                        JOptionPane.showMessageDialog(null, "User Login Successful!", "Warning!",
                        JOptionPane.WARNING_MESSAGE);
                    }
